...
const services = [
  { n: "01", title: "Брендинг", desc: "Стратегия, платформа бренда, нейминг и характер коммуникации." },
  { n: "02", title: "Айдентика", desc: "Логотип, фирменный стиль, гайдлайны, носители." },
  { n: "03", title: "Веб-дизайн", desc: "Лендинги, сайты, интерфейсы — от концепции до прототипа." },
  { n: "04", title: "Разработка", desc: "Next.js, анимации на GSAP, интеграции, поддержка." },
  { n: "05", title: "Полиграфия", desc: "Упаковка, этикетки, печатные материалы премиум-уровня." },
  { n: "06", title: "Моушн", desc: "Анимация, видео, motion-айдентика для соцсетей и сайта." },
];
